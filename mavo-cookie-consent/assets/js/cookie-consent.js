...
( function () {
	...
	function dismiss() {
		...
		// Restore all cookies that were suppressed pending consent.
		if ( config.pendingCookies && config.pendingCookies.length ) {
			config.pendingCookies.forEach( function ( cookie ) {
